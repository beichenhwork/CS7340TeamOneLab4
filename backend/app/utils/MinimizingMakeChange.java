...
import utils.MinimizingMakeChangeFitnessFunction;
...
public class MinimizingMakeChange {
   ...
   * @since 1.0
   */
  public static ObjectNode  makeChangeForAmount(int a_targetChangeAmount,
      boolean a_doMonitor)
      throws Exception {

    //Return a Json node to the controller.
    ...
    res.put("evolutionTime", ( endTime - startTime)
            + " ms");
    ...
    if(v1 > v2){
      String bestSolution = "The best solution is path 1 sc1 -> sc2 -> sc3 which has a fitness value of " +
      ...
      String bestSolution = "The best solution is path 2 sc1 -> sc3 which has a fitness value of " +
  ...
  /**
   * Set an API to transfer result to backend!
   */
